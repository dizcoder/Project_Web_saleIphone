...
<body>
    ...
    <div class="py-2 border-bottom ml-3">
        ...
        <div id="orange"><span class="fa fa-minus"></span></div>
        <form>
            <div class="form-group"> <input type="checkbox" id="artisan"> <label for="artisan">32G</label> </div>
            <div class="form-group"> <input type="checkbox" id="artisan"> <label for="artisan">64G</label> </div>
            <div class="form-group"> <input type="checkbox" id="artisan"> <label for="artisan">128G</label> </div>
            <div class="form-group"> <input type="checkbox" id="artisan"> <label for="artisan">512G</label> </div>
            <div class="form-group"> <input type="checkbox" id="artisan"> <label for="artisan">1TB</label> </div>
        </form>
    <div/>
</section>
    <!-- End filter -->
...
<!--                <div id="sorting" class="border rounded p-1 m-1"> <span class="text-muted">Sort by</span> <select name="sort" id="sort">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div class="card"> <img class="card-img-top" src="<%= c.getImage()%>">
                    <div class="card-body">
                        <h5><b><%= c.getName()%></b> </h5>
                        <div class="d-flex flex-row my-2">
                            <div class="text-muted"><%= c.getPrice()%></div>
